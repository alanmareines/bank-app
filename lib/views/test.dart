...
class SlackApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
        title: 'Slack', home: HomeScreen(), debugShowCheckedModeBanner: false);
  }
}
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          SizedBox(width: 10),
          ClipOval(
              child: Container(color: Colors.yellow, width: 12, height: 12)),
          SizedBox(width: 10),
          ClipOval(
              child: Container(color: Colors.green, width: 12, height: 12)),
          Expanded(
            child: Row(
                    ...
                    child: ConstrainedBox(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                            ...
                            border:
                                Border.all(color: Color(0xFF42484B), width: 1)),
                        child: Row(
                          mainAxisAlignment: MainAxisAlignment.center,
                          children: [
                            Icon(Icons.search,
...
class WorkspaceSectionState extends State<WorkspaceSection>
            ...
            Channel()
              ...
              ..chats = [
                ...
                Chat()
                  ..user = Utils.userLogged
                  ..text =
                      'https://media2.giphy.com/media/4PY2P7jVGwJpNb9TLl/giphy.gif'
            ...
            Channel()
              ...
              ..chats = [
                ...
                Chat()
                  ..user = Utils.tim
                  ..text =
                      '🙌 https://i1.wp.com/blog.codepen.io/wp-content/uploads/2020/03/flutter-on-codepen.png'
              ...
              ..topic =
                  'Announcements - Please use Threads for conversations in this channel.',
            Channel()
              ...
              ..chats = [
                Chat()
                  ..user = Utils.nilay
                  ..text =
                      'If you need help for events and community related, make sure to contact me 😊'
            ...
            Channel()
              ...
              ..chats = [
                Chat()
                  ..user = Utils.userLogged
                  ..text =
                      'CodePen continues to amaze me! https://miro.medium.com/max/800/1*Otx7CXIY9eh0Sxlp54olxA.png'
        ...
        Workspace()
          ...
          ..channels = [
            ...
            Channel()
              ..name = 'admin'
              ..private = true
              ..users = [Utils.userLogged, Utils.ariel]
              ..chats = [],
          ]
          ..users = [
            Utils.userLogged,
    ...
    list.asMap().forEach((key, value) {
      if (list[key].key.currentState != null) {
        list[key]
            .key
            .currentState
            .selected(selected is bool ? selected : key == selected);
      }
    });
  }
  ...
  void initState() {
    ...
    _leftPanel = Tween<Offset>(begin: Offset(-1, 0), end: Offset.zero)
        .animate(_leftController);
    _middleLeftPanel = Tween<Offset>(begin: Offset(0, 0), end: Offset(0.85, 0))
        .animate(_leftController);
    _middleRightPanel =
        Tween<Offset>(begin: Offset(0, 0), end: Offset(-0.15, 0))
            .animate(_rightController);
    _rightPanel = Tween<Offset>(begin: Offset(1, 0), end: Offset.zero)
        .animate(_rightController);

    _clickItem = (index) {
      _workspacesItems.forEach((element) {
        if (element is WorkspaceItem) {
          (element.key as GlobalKey<WorkspaceItemState>)
              .currentState
    ...
    _workspaces.asMap().forEach((index, value) {
      setState(() => _workspacesItems.add(WorkspaceItem(
          ...
          index: index,
          selected: index == 0,
          workspace: value.first,
          clickItem: _clickItem)));
    });
    _workspacesItems.add(AspectRatio(
        key: GlobalKey(),
        aspectRatio: 1,
        child: Container(child: Icon(Icons.add, color: Color(0xFFACADAF)))));

    _closeItem = (index) => Future.microtask(() => setState(() {
          _dms.removeAt(index);
          _workspaces[_currentIndex].first.dms.removeAt(index);
          _workspaces[_currentIndex].first.currentChannel =
              _workspaces[_currentIndex].first.currentChannel;
          _workspaces[_currentIndex].first.currentDM = -1;
          (_channels[_workspaces[_currentIndex].first.currentChannel].key
                  as GlobalKey<ChannelItemState>)
              .currentState
              .selected(true);
          _dms.asMap().forEach((key, value) {
            (_dms[key].key as GlobalKey<DMUserItemState>)
                .currentState
                .index(key);
          });
        }));
  ...
  Widget _mobileView(Size size) {
    ...
    final channel = channelIndex > -1
        ? _workspaces[_currentIndex].first.channels[channelIndex]
        : null;
    final dmIndex = _workspaces[_currentIndex].first.currentDM;
    final dm =
        dmIndex > -1 ? _workspaces[_currentIndex].first.dms[dmIndex] : null;
    return GestureDetector(
      onHorizontalDragUpdate: (details) {
        ...
        _activePanel.value +=
            details.primaryDelta * _direction / context.size.width;
      },
          ...
          AnimatedBuilder(
            ...
            builder: (BuildContext context, Widget child) {
              ...
              return SlideTransition(
                  position: AlwaysStoppedAnimation(value), child: child);
            },
            child: Stack(
              children: [
                Scaffold(
                      ...
                      child: Container(
                        ...
                        child: _workspaces[_currentIndex].first.logo != null
                            ? ClipRRect(
                                ...
                                child: Image.network(
                                    _workspaces[_currentIndex].first.logo),
                              )
                            : Container(
                                decoration: BoxDecoration(
                                  color: Colors.grey,
                      ...
                      Expanded(
                        child: ListView(
                          children: [
                            ...
                            _titleSection(
                                'Direct messages',
                                () => setState(() => _showDMs = !_showDMs),
                                _showDMs,
                                null),
                            if (_showDMs) ..._dms,
                            if (_showDMs)
                              _itemSideMenu(Icons.add, 'Invite People'),
                            SizedBox(height: 15),
                          ],
                        ),
                      ),
                      ...
                      child: Center(
                        child: Column(
                          ...
                          children: [
                            ...
                            SizedBox(height: 5),
                            _itemSideMenu(Icons.input,
                                'Sign out of ${_workspaces[_currentIndex].first.name}'),
                          ],
                        ),
                      ),
                    ),
      ...
      child: BottomNavigationBar(
        items: [
          BottomNavigationBarItem(
              ...
              title: Text('Home')),
          BottomNavigationBarItem(
              icon: SizedBox(height: 30, child: Icon(Icons.message)),
              title: Text('DMs')),
          BottomNavigationBarItem(
              icon: SizedBox(height: 30, child: Icon(Utils.at)),
              title: Text('Mentions')),
          BottomNavigationBarItem(
              icon: SizedBox(height: 30, child: Icon(Icons.insert_emoticon)),
              title: Text('You')),
        ],
        elevation: 0,
        currentIndex: 0,
                ...
                child: Row(
                  children: [
                    ...
                    Container(
                      ...
                      child:
                          Icon(Icons.edit, color: Color(0xFF1C2128), size: 18),
                    ),
                    SizedBox(width: 15),
                  ],
                ),
              ...
              Expanded(
                child: ListView(
                  children: [
                    ...
                    _menuSection(
                        _showMenus ? Icons.arrow_upward : Icons.arrow_downward,
                        'Show more',
                          ...
                          children: [
                            ...
                            Expanded(
                              child: Text(
                                dm.user.description ?? '',
                                style:
                                    TextStyle(color: Colors.grey, height: 1.2),
                                maxLines: 1,
                                overflow: TextOverflow.ellipsis,
                              ),
                            ),
                ...
                Padding(
                  ...
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                      border: InputBorder.none,
                      hintText:
                          'Message #${dm.user.name} ${dm.user.status ?? ''}',
                      hintStyle: TextStyle(
  ...
  Widget _chatView(List<Chat> chats) {
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        var sameUser = index + 1 <= chats.length - 1 &&
            chats[index + 1].user.id == chat.user.id;
  ...
  Widget _titleSection(String title, GestureTapCallback toggleTap, bool show,
      ...
      child: Row(
        children: [
          ...
          GestureDetector(
            ...
            child: Container(
              height: 40,
              child: Icon(show ? Icons.arrow_drop_down : Icons.arrow_right,
                  color: Color(0xFFC7C8CA), size: 20),
            ),
          ),
          SizedBox(width: 8),
          Expanded(
  ...
  _initChannels(bool clear) {
    ...
    _workspaces[_currentIndex].first.channels.asMap().forEach((index, channel) {
      setState(() => _channels.add(ChannelItem(
          key: GlobalKey<ChannelItemState>(),
          channel: channel,
          index: index,
          clickItem: _chanlItem)));
    });
                ...
                children: [
                  if (!widget.sameUser)
                    Container(
                      ...
                      child: ClipRRect(
                        borderRadius: BorderRadius.circular(5),
                        child: Image.network(widget.chat.user.avatar,
                            fit: BoxFit.cover),
                      ),
                    ),
...
class ChannelItem extends StatefulWidget {
  ...
  const ChannelItem({Key key, this.index, this.channel, this.clickItem})
      : super(key: key);
        ...
        child: Row(
          children: [
            ...
            Container(
              height: 30,
              child: Icon(
                  widget.channel.private
                      ? Icons.lock
                      : IconData(0x23, fontFamily: 'Roboto'),
                  color: _selected ? Colors.white : Color(0xAAC7C8CA),
                  size: 15),
            ),
            SizedBox(width: 8),
            Container(
...
class DMUserItem extends StatefulWidget {
  ...
  const DMUserItem(
      {Key key, this.user, this.index, this.chatListener, this.closeItem})
      : super(key: key);
...
class DMUserItemState extends State<DMUserItem> {
  ...
  Widget build(BuildContext context) {
    return MouseRegion(
      ...
      child: InkWell(
        onTap: () =>
            widget.chatListener(_index == null ? widget.index : _index),
        child: Container(
          color: _selected ? Color(0xFF1064A3) : Colors.transparent,
          height: 30,
          child: Row(
            children: [
              SizedBox(width: 20),
              widget.user.online
                  ? Utils.online(_selected)
                  : Utils.offline(_selected),
              SizedBox(width: 8),
              Expanded(
                child: Row(
                  children: [
                    ...
                    if (widget.user.status != null)
                      Padding(
                        ...
                        child: Text(
                          widget.user.status,
                          style:
                              TextStyle(color: Colors.grey[700], height: 1.2),
                          maxLines: 1,
                          overflow: TextOverflow.ellipsis,
                        ),
                      ),
              ...
              Opacity(
                ...
                child: InkWell(
                  onTap: () =>
                      widget.closeItem(_index == null ? widget.index : _index),
...
class WorkspaceItemState extends State<WorkspaceItem> {
  ...
  void initState() {
    super.initState();
    if (mounted)
      Future.microtask(() => setState(() => _selected = widget.selected));
  }
...
class Utils {
  ...
  static final scott = User()
    ...
    ..name = 'Scott'
    ..avatar =
        'https://pbs.twimg.com/profile_images/1050017782811713536/6tKkzfsI_400x400.jpg'
    ..online = true;
  ...
  static final nash = User()
    ...
    ..name = 'Nash Ramdial'
    ..avatar =
        'https://pbs.twimg.com/profile_images/1180232818779021312/xlZcHrlQ_400x400.jpg'
    ..online = false;
  ...
  static final ariel = User()
    ...
    ..status = '🇦🇷'
    ..avatar =
        'https://pbs.twimg.com/profile_images/1204953056686809089/2wwFUZNZ_400x400.jpg'
    ..online = true;
  ...
  static Text online(bool selected) => Text('\u25CF',
      style: TextStyle(
          color: selected ? Colors.grey[300] : Color(0xFF93E865),
          fontSize: 20));

  static Text offline(bool selected) => Text('\u25CB',
      style: TextStyle(
          color: selected ? Colors.grey[300] : Colors.grey, fontSize: 20));

  static final RegExp regexpEmoji = RegExp(
      r'(\u00a9|\u00ae|[\u2000-\u3300]|\ud83c[\ud000-\udfff]|\ud83d[\ud000-\udfff]|\ud83e[\ud000-\udfff])');
  static final RegExp regexAlphaNum = RegExp(r'[a-zA-Z0-9]');
  static final RegExp regexImageUrl =
      RegExp(r'(https?:\/\/.*\.(?:png|jpg|gif))');
